...
var file_manager_manager_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x09, 0x6e, 0x61, 0x6d, 0x65, 0x73, 0x70, 0x61, 0x63, 0x65, 0x2a, 0xad, 0x01, 0x0a,
	...
	0x0a, 0x08, 0x42, 0x41, 0x44, 0x5f, 0x41, 0x52, 0x47, 0x53, 0x10, 0x08, 0x32, 0xd5, 0x17, 0x0a,
...
var file_manager_manager_proto_msgTypes = make([]protoimpl.MessageInfo, 60)
var file_manager_manager_proto_goTypes = []any{
	...
	nil,                               // 54: telepresence.manager.PreviewSpec.AddRequestHeadersEntry
	...
	nil,                               // 58: telepresence.manager.ReviewInterceptRequest.HeadersEntry
	nil,                               // 59: telepresence.manager.ReviewInterceptRequest.MetadataEntry
	nil,                               // 60: telepresence.manager.ReviewInterceptRequest.EnvironmentEntry
	nil,                               // 61: telepresence.manager.LogsResponse.PodLogsEntry
	nil,                               // 62: telepresence.manager.LogsResponse.PodYamlEntry
	nil,                               // 63: telepresence.manager.DialRequest.TraceContextEntry
	(*WorkloadInfo_Intercept)(nil),    // 64: telepresence.manager.WorkloadInfo.Intercept
...
var file_manager_manager_proto_depIdxs = []int32{
	...
	54, // 3: telepresence.manager.PreviewSpec.add_request_headers:type_name -> telepresence.manager.PreviewSpec.AddRequestHeadersEntry
	...
	55, // 8: telepresence.manager.InterceptInfo.headers:type_name -> telepresence.manager.InterceptInfo.HeadersEntry
	56, // 9: telepresence.manager.InterceptInfo.metadata:type_name -> telepresence.manager.InterceptInfo.MetadataEntry
	57, // 10: telepresence.manager.InterceptInfo.environment:type_name -> telepresence.manager.InterceptInfo.EnvironmentEntry
	65, // 11: telepresence.manager.InterceptInfo.modified_at:type_name -> google.protobuf.Timestamp
	...
	58, // 24: telepresence.manager.ReviewInterceptRequest.headers:type_name -> telepresence.manager.ReviewInterceptRequest.HeadersEntry
	59, // 25: telepresence.manager.ReviewInterceptRequest.metadata:type_name -> telepresence.manager.ReviewInterceptRequest.MetadataEntry
	60, // 26: telepresence.manager.ReviewInterceptRequest.environment:type_name -> telepresence.manager.ReviewInterceptRequest.EnvironmentEntry
	11, // 27: telepresence.manager.RemainRequest.session:type_name -> telepresence.manager.SessionInfo
	66, // 28: telepresence.manager.LogLevelRequest.duration:type_name -> google.protobuf.Duration
	61, // 29: telepresence.manager.LogsResponse.pod_logs:type_name -> telepresence.manager.LogsResponse.PodLogsEntry
	62, // 30: telepresence.manager.LogsResponse.pod_yaml:type_name -> telepresence.manager.LogsResponse.PodYamlEntry
	63, // 31: telepresence.manager.DialRequest.trace_context:type_name -> telepresence.manager.DialRequest.TraceContextEntry
	...
	64, // 47: telepresence.manager.WorkloadInfo.intercept_clients:type_name -> telepresence.manager.WorkloadInfo.Intercept
	...
	65, // 51: telepresence.manager.WorkloadEventsDelta.since:type_name -> google.protobuf.Timestamp
	...
	65, // 54: telepresence.manager.WorkloadEventsRequest.since:type_name -> google.protobuf.Timestamp
	53, // 55: telepresence.manager.AgentInfo.ContainerInfo.environment:type_name -> telepresence.manager.AgentInfo.ContainerInfo.EnvironmentEntry
	51, // 56: telepresence.manager.AgentInfo.ContainersEntry.value:type_name -> telepresence.manager.AgentInfo.ContainerInfo
	67, // 57: telepresence.manager.Manager.Version:input_type -> google.protobuf.Empty
	67, // 58: telepresence.manager.Manager.GetAgentImageFQN:input_type -> google.protobuf.Empty
	67, // 59: telepresence.manager.Manager.GetLicense:input_type -> google.protobuf.Empty
	67, // 60: telepresence.manager.Manager.CanConnectAmbassadorCloud:input_type -> google.protobuf.Empty
	67, // 61: telepresence.manager.Manager.GetCloudConfig:input_type -> google.protobuf.Empty
	67, // 62: telepresence.manager.Manager.GetClientConfig:input_type -> google.protobuf.Empty
	67, // 63: telepresence.manager.Manager.GetTelepresenceAPI:input_type -> google.protobuf.Empty
	5,  // 64: telepresence.manager.Manager.ArriveAsClient:input_type -> telepresence.manager.ClientInfo
	6,  // 65: telepresence.manager.Manager.ArriveAsAgent:input_type -> telepresence.manager.AgentInfo
	22, // 66: telepresence.manager.Manager.Remain:input_type -> telepresence.manager.RemainRequest
	11, // 67: telepresence.manager.Manager.Depart:input_type -> telepresence.manager.SessionInfo
	23, // 68: telepresence.manager.Manager.SetLogLevel:input_type -> telepresence.manager.LogLevelRequest
	24, // 69: telepresence.manager.Manager.GetLogs:input_type -> telepresence.manager.GetLogsRequest
	11, // 70: telepresence.manager.Manager.WatchAgentPods:input_type -> telepresence.manager.SessionInfo
	11, // 71: telepresence.manager.Manager.WatchAgents:input_type -> telepresence.manager.SessionInfo
	12, // 72: telepresence.manager.Manager.WatchAgentsNS:input_type -> telepresence.manager.AgentsRequest
	11, // 73: telepresence.manager.Manager.WatchIntercepts:input_type -> telepresence.manager.SessionInfo
	49, // 74: telepresence.manager.Manager.WatchWorkloads:input_type -> telepresence.manager.WorkloadEventsRequest
	11, // 75: telepresence.manager.Manager.WatchClusterInfo:input_type -> telepresence.manager.SessionInfo
	16, // 76: telepresence.manager.Manager.EnsureAgent:input_type -> telepresence.manager.EnsureAgentRequest
	15, // 77: telepresence.manager.Manager.PrepareIntercept:input_type -> telepresence.manager.CreateInterceptRequest
	15, // 78: telepresence.manager.Manager.CreateIntercept:input_type -> telepresence.manager.CreateInterceptRequest
	19, // 79: telepresence.manager.Manager.RemoveIntercept:input_type -> telepresence.manager.RemoveInterceptRequest2
	18, // 80: telepresence.manager.Manager.UpdateIntercept:input_type -> telepresence.manager.UpdateInterceptRequest
	20, // 81: telepresence.manager.Manager.GetIntercept:input_type -> telepresence.manager.GetInterceptRequest
	21, // 82: telepresence.manager.Manager.ReviewIntercept:input_type -> telepresence.manager.ReviewInterceptRequest
	11, // 83: telepresence.manager.Manager.GetKnownWorkloadKinds:input_type -> telepresence.manager.SessionInfo
	33, // 84: telepresence.manager.Manager.LookupDNS:input_type -> telepresence.manager.DNSRequest
	35, // 85: telepresence.manager.Manager.AgentLookupDNSResponse:input_type -> telepresence.manager.DNSAgentResponse
	11, // 86: telepresence.manager.Manager.WatchLookupDNS:input_type -> telepresence.manager.SessionInfo
	67, // 87: telepresence.manager.Manager.WatchLogLevel:input_type -> google.protobuf.Empty
	31, // 88: telepresence.manager.Manager.Tunnel:input_type -> telepresence.manager.TunnelMessage
	44, // 89: telepresence.manager.Manager.ReportMetrics:input_type -> telepresence.manager.TunnelMetrics
	11, // 90: telepresence.manager.Manager.WatchDial:input_type -> telepresence.manager.SessionInfo
	27, // 91: telepresence.manager.Manager.Version:output_type -> telepresence.manager.VersionInfo2
	41, // 92: telepresence.manager.Manager.GetAgentImageFQN:output_type -> telepresence.manager.AgentImageFQN
	28, // 93: telepresence.manager.Manager.GetLicense:output_type -> telepresence.manager.License
	30, // 94: telepresence.manager.Manager.CanConnectAmbassadorCloud:output_type -> telepresence.manager.AmbassadorCloudConnection
	29, // 95: telepresence.manager.Manager.GetCloudConfig:output_type -> telepresence.manager.AmbassadorCloudConfig
	40, // 96: telepresence.manager.Manager.GetClientConfig:output_type -> telepresence.manager.CLIConfig
	26, // 97: telepresence.manager.Manager.GetTelepresenceAPI:output_type -> telepresence.manager.TelepresenceAPIInfo
	11, // 98: telepresence.manager.Manager.ArriveAsClient:output_type -> telepresence.manager.SessionInfo
	11, // 99: telepresence.manager.Manager.ArriveAsAgent:output_type -> telepresence.manager.SessionInfo
	67, // 100: telepresence.manager.Manager.Remain:output_type -> google.protobuf.Empty
	67, // 101: telepresence.manager.Manager.Depart:output_type -> google.protobuf.Empty
	67, // 102: telepresence.manager.Manager.SetLogLevel:output_type -> google.protobuf.Empty
	25, // 103: telepresence.manager.Manager.GetLogs:output_type -> telepresence.manager.LogsResponse
	43, // 104: telepresence.manager.Manager.WatchAgentPods:output_type -> telepresence.manager.AgentPodInfoSnapshot
	13, // 105: telepresence.manager.Manager.WatchAgents:output_type -> telepresence.manager.AgentInfoSnapshot
	13, // 106: telepresence.manager.Manager.WatchAgentsNS:output_type -> telepresence.manager.AgentInfoSnapshot
	14, // 107: telepresence.manager.Manager.WatchIntercepts:output_type -> telepresence.manager.InterceptInfoSnapshot
	48, // 108: telepresence.manager.Manager.WatchWorkloads:output_type -> telepresence.manager.WorkloadEventsDelta
	37, // 109: telepresence.manager.Manager.WatchClusterInfo:output_type -> telepresence.manager.ClusterInfo
	13, // 110: telepresence.manager.Manager.EnsureAgent:output_type -> telepresence.manager.AgentInfoSnapshot
	17, // 111: telepresence.manager.Manager.PrepareIntercept:output_type -> telepresence.manager.PreparedIntercept
	10, // 112: telepresence.manager.Manager.CreateIntercept:output_type -> telepresence.manager.InterceptInfo
	67, // 113: telepresence.manager.Manager.RemoveIntercept:output_type -> google.protobuf.Empty
	10, // 114: telepresence.manager.Manager.UpdateIntercept:output_type -> telepresence.manager.InterceptInfo
	10, // 115: telepresence.manager.Manager.GetIntercept:output_type -> telepresence.manager.InterceptInfo
	67, // 116: telepresence.manager.Manager.ReviewIntercept:output_type -> google.protobuf.Empty
	45, // 117: telepresence.manager.Manager.GetKnownWorkloadKinds:output_type -> telepresence.manager.KnownWorkloadKinds
	34, // 118: telepresence.manager.Manager.LookupDNS:output_type -> telepresence.manager.DNSResponse
	67, // 119: telepresence.manager.Manager.AgentLookupDNSResponse:output_type -> google.protobuf.Empty
	33, // 120: telepresence.manager.Manager.WatchLookupDNS:output_type -> telepresence.manager.DNSRequest
	23, // 121: telepresence.manager.Manager.WatchLogLevel:output_type -> telepresence.manager.LogLevelRequest
	31, // 122: telepresence.manager.Manager.Tunnel:output_type -> telepresence.manager.TunnelMessage
	67, // 123: telepresence.manager.Manager.ReportMetrics:output_type -> google.protobuf.Empty
	32, // 124: telepresence.manager.Manager.WatchDial:output_type -> telepresence.manager.DialRequest
...
func file_manager_manager_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_manager_manager_proto_msgTypes[59].Exporter = func(v any, i int) any {
